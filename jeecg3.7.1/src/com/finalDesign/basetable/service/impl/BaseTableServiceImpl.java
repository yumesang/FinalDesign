package com.finalDesign.basetable.service.impl;
...
@Transactional
public class BaseTableServiceImpl extends CommonServiceImpl implements BaseTableServiceI {
	 ...
	 * @return
	 */
	private void doAddBus(BaseTableEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doUpdateBus(BaseTableEntity t) throws Exception{
		//-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
	 ...
	 * @return
	 */
	private void doDelBus(BaseTableEntity t) throws Exception{
	    //-----------------sql增强 start----------------------------
	 	//-----------------sql增强 end------------------------------
 	...
 	private Map<String,Object> populationMap(BaseTableEntity t){
		Map<String,Object> map = new HashMap<String,Object>();
		map.put("id", t.getId());
		map.put("list_name", t.getListName());
		map.put("list_type", t.getListType());
		map.put("list_url", t.getListUrl());
		...
		map.put("use_count", t.getUseCount());
	 ...
	 */
 	public String replaceVal(String sql,BaseTableEntity t){
 		...
 		sql  = sql.replace("#{use_count}",String.valueOf(t.getUseCount()));
 		...
 		if(StringUtil.isNotEmpty(cgJavaValue)){
			...
			try {
				...
				if(obj instanceof CgformEnhanceJavaInter){
					...
					javaInter.execute("base_table",data);
				}
			} catch (Exception e) {
				e.printStackTrace();
