...
<div class="easyui-layout" fit="true">
  ...
  <t:datagrid name="notebookList" checkbox="true" pagination="true" fitColumns="true" title="notebook" actionUrl="notebookController.do?datagrid&enable=0&isPass=1" idField="id" fit="true" queryMode="group">
