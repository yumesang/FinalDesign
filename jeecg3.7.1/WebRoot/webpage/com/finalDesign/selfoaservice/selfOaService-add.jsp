...
<html>
 ...
 <body>
  <t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="selfOaServiceController.do?doAdd" >
		...
		<table style="width: 600px;" cellpadding="0" cellspacing="1" class="formtable">
				<tr>
					...
					<td class="value">
					     	 <input id="oaName" name="oaName" type="text" style="width: 150px" class="inputxt"   datatype="*" />
					...
					<td class="value">
					     	 <input placeholder="请输入1-5之间的数字" id="nodeNum" name="nodeNum" type="text" style="width: 150px" class="inputxt" datatype="n" onchange="setNode(value)" ignore="ignore" />
							<span class="Validform_checktip"></span>
				...
				<tr hidden="hidden" style="height: 80px;" id="node1" align="center" >
					<td>
					 ...
					 <td colspan="3">
					 	<input id="roleid1" name="roleid1" type="hidden" value="${id}"/>
                		<input name="roleName1" id="roleName1" class="inputxt" value="${roleName }" readonly="readonly" />
				...
				<tr hidden="hidden" style="height: 80px;" id="node3" align="center" >
					<td>
					 ...
					 <td colspan="3">
					 	<input id="roleid3" name="roleid3" type="hidden" value="${id}"/>
                		<input name="roleName3" id="roleName3" class="inputxt" value="${roleName }" readonly="readonly"  />
				...
				<tr hidden="hidden" style="height: 80px;" id="node4" align="center" >
					<td>
					 ...
					 <td colspan="3">
					 	<input id="roleid4" name="roleid4" type="hidden" value="${id}"/>
                		<input name="roleName4" id="roleName4" class="inputxt" value="${roleName }" readonly="readonly"  />
				...
				<tr hidden="hidden" style="height: 80px;" id="node5" align="center" >
					<td>
					 ...
					 <td colspan="3">
					 	<input id="roleid5" name="roleid5" type="hidden" value="${id}"/>
                		<input name="roleName5" id="roleName5" class="inputxt" value="${roleName }" readonly="readonly"  />
				...
				<input id="oaDateilId" name="oaDetailId" type="text" style="width: 200px;display:none;" value="" datatype="*" />
				<input id="oaDateilName" name="oaDetailName" type="text" style="width: 200px;display:none;" value="" datatype="*" />
				<!-- <tr>
					<td align="right">
						<label class="Validform_label">
							流程等级:
